  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form action="rental?page=forgot"  method="post" class="sign-in-form" id="verifyForm" onsubmit="return validatePhoneNumber()">
          ...
          <div class="error" style="color: #ff3860;" id="error-message"><%= request.getAttribute("errorMessage1") %></div>
          <% } %>
