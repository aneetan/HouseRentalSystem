...
<body>
  ...
  <script>
    ...
    const changePwForm = document.getElementById("newPasswordForm");
    ...
    const isValidPassword = newPassword => {
      ...
      return pw.test(String(newPassword).toLowerCase());
    }
    ...
    const validateInputs = () => {
      ...
      if(passwordValue === '') {
        ...
        setError(newPassword,'Password must be 7 characters');
        isValid=false;
      } else if (!isValidPassword(passwordValue)) {
        setError(newPassword,'Please insert strong password');
        isValid=false;
      } else {
